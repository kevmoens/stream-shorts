...
namespace StreamShorts.Library.Analysis.ChatGPT;
#pragma warning disable CA1063 // Implement IDisposable Correctly
#pragma warning disable CA1816 // Implement IDisposable Correctly
public class ChatGPTAnalyzer : ITranscriptAnalyzer, IDisposable
{
  ...
  public ChatGPTAnalyzer(IAnalysisPrompt analysisPrompt, Settings settings)
  {
    ...
    _kernel = Kernel.CreateBuilder()
      .AddOpenAIChatCompletion(modelId, _settings.ChatGptApiKey!)
      .Build();
  }
